...
type CheckoutBillingProps = {
  onSubmit: (sameAsBilling: boolean, fields: CheckoutFields) => void
  defaultSameAsBilling?: boolean
  defaultFields?: Partial<CheckoutFields>
}
...
const CheckoutBilling: React.FC<CheckoutBillingProps> = ({
  ...
  const [state, dispatch] = useReducer(
    (state: CheckoutBillingState, action: CheckoutBillingAction) => {
      switch (action.type) {
  ...
  const changeField = (field: keyof CheckoutFields, value: string) => {
